# forked from https://pypi.org/project/xdi-pandas/
# adjusted/fixed to work within this project
# Victor Rogalev DLS 2022
import re
...
def parse_namespace_tag(l):
    ...
    if " " in path:
        raise ValueError(
            'Bad field: "%s" should not contain " ". Namespace should be separated from tag with ".".' % path)
