...
urlpatterns = [
    ...
    re_path(r'^password_reset_confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,32})/$', views.PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
